...
import { StyleSheet, View, Text, ActivityIndicator, ScrollView,Image, TouchableOpacity, Share, Platform,Ionicons } from 'react-native'
    ...
    if (this.state.film != undefined) {
      return (
        <ScrollView style={styles.scrollview_container}>
          ...
          <Text style = {styles.default_text}> Nombre de vote : {this.state.film.vote_count} </Text>
          ...
          <Text style = {styles.default_text}> Companie(s) : {this.state.film.production_companies.map(function(companies) {
